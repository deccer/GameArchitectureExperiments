...
namespace Lidgren.Network
{
    public partial class NetPeer
    {
        ...
        public void Recycle(NetIncomingMessage msg)
        {
            ...
            NetException.Assert(!m_incomingMessagesPool.Contains(msg), "Recyling already recycled incoming message! Thread race?");
        ...
        internal void Recycle(NetOutgoingMessage msg)
        {
            if (m_outgoingMessagesPool == null)
                return;
#if DEBUG
            NetException.Assert(!m_outgoingMessagesPool.Contains(msg), "Recyling already recycled outgoing message! Thread race?");
